...
export const customProperties = (type: string) => {
...
.alert-wrapper {
  ...
  height: auto;
  background: var(--ds-alert--background-color);
  border-radius: var(--ds-alert--spacing-8);
  padding: var(--ds-alert--spacing-8) var(--ds-alert--spacing-16);
  box-sizing: border-box;
  margin-bottom:var(--ds-alert--spacing-4);
}
...
.title-icon {
  display: flex;
  margin-right: var(--ds-alert--spacing-8);
}

.close-icon {
  display: flex;
  margin-left: var(--ds-alert--spacing-8);
  cursor:pointer;
}

label{
   font:var(--ds-alert--title-font);
   color:var(--ds-alert--font-color);
}
...
::slotted([slot="content"]) {
  font:var(--ds-alert--content-font);
  color:var(--ds-alert--font-color);
  padding-top:var(--ds-alert--spacing-8);
}

::slotted([slot="content-button"]){
  width:auto;
  display: flex;
  justify-content: space-around;
  float: right;
  padding-top:var(--ds-alert--spacing-8);
  gap: var(--ds-alert--spacing-8);
}
